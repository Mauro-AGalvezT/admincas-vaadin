package com.cas.application.views.tutor;

import com.cas.application.data.entity.SamplePerson;
import com.cas.application.data.service.SamplePersonService;
import com.cas.application.views.MainLayout;
...
@PageTitle("Tutor")
@Route(value = "Tutor/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class TutorView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "Tutor/%s/edit";
    ...
    public TutorView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("tutor-view");
